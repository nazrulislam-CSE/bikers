        ...
        <div class="row row-sm">
            ...
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex">
                        <a href="{{ route('admin.story.index') }}" class="btn btn-danger me-2">
                            <i class="fas fa-list d-inline"></i> Story List
                        </a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-12 col-lg-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" title="Title" id="basic-addon1"><i
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                <label for="image">Photo <span
                                        class="text-danger font-weight-bolder">(Size:100,100px)</span>:</label>
                                @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="input-group">
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                <img id="showImage"
                                    src="{{ !empty($story->image) ? url('upload/story/' . $story->image) : url('upload/no_image.jpg') }}"
                            ...
                            <div class="form-group col-xl-12 col-lg-6 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="status" class=" form-control">
                                        ...
                                        <option value="1" @if ($story->status == 1) selected @endif>Active
                                        </option>
                                        <option value="0" @if ($story->status == 0) selected @endif>Deactive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                                <button type="submit" class="add-to-cart btn btn-success btn-block"><i
                                        class="fas fa-paper-plane"></i> Update Story</button>
                            </div>
                        </div>
                    </form>
                </div>
