                ...
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <p class="card-title my-0">{{ $pageTitle ?? 'Page Title' }} <span class="badge bg-danger side-badge"
                                style="font-size:17px;">{{ count($stories) }}</span> </p>

                        <div class="d-flex">
                            <a href="{{ route('admin.story.create') }}" class="btn btn-success me-2">
                                <i class="fas fa-plus d-inline"></i> Add Now Story
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($stories as $key => $story)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.story.destroy', $story->id) }}"
