                ...
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <p class="card-title my-0">{{ $pageTitle ?? 'Page Title' }} <span class="badge bg-danger side-badge"
                                style="font-size:17px;">{{ count($newsEvents) }}</span> </p>

                        <div class="d-flex">
                            <a href="{{ route('admin.news-events.create') }}" class="btn btn-success me-2">
                                <i class="fas fa-plus d-inline"></i> Add Now News Event
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($newsEvents as $key => $news)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.news-events.edit', $news->id) }}"
                                                    class="btn btn-primary btn-sm me-1" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="{{ route('admin.news-events.destroy', $news->id) }}"
