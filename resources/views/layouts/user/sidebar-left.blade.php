    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu ">
                ...
                <li class="slide {{ Request::is('user/bike/register*') ? 'is-expanded' : '' }}">
                    ...
                    <ul class="slide-menu">
                        <li>
                            <a class="slide-item {{ Request::is('user/bike/register/create') ? 'active' : '' }}" href="{{ route('user.bike.register.create') }}">Register My Bike</a>
                        </li>
                        <li>
