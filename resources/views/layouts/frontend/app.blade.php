...
<body>
                    ...
                    <div class="col-xs-8">
                        <div class="header-contacts clearfix">
                            ...
                            <div class="header-contacts__one">
                                ...
                                <a href="contacts.html" class="header-contacts__link">info@domain.com</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="anons">
        <div class="container">
            ...
            c0.794,0,1.592-0.135,2.358-0.408l343.757-123.035c3.312-1.186,5.229-4.644,4.48-8.08L448.068,271.461z" />
                        ...
                        <h2><a href="shop.html" class="title no-decoration"><span
                                    class="title__bold">Biker</span>Shop</a></h2>
            ...
            S430.709,344.58,406.162,344.58z" />
                        ...
                        <h2><a href="#" class="title no-decoration"><span
                                    class="title__bold">Biker</span>Types</a></h2>
                        <p class="text">Nunc molestie sapien tempor placerat</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <div class="we-are__img wow fadeInLeft" data-wow-delay="0.7s" data-wow-duration="1.5s"><img
                            class="img-responsive" src="{{ asset('frontend/media/570x325/moto.jpg') }}"
                            alt="moto" /></div>
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="we-are__img wow fadeInRight" data-wow-delay="0.7s" data-wow-duration="2.5s"><img
                            class="img-responsive" src="{{ asset('frontend/media/570x325/moto2.jpg') }}"
                            alt="moto" /></div>
                </div>
            </div>
        </div>
    ...
    <section class="offers dark-bg">
        <div class="container">
            <h2 class="title title--main"><span class="title__bold">BIKER<span>Club</span></span>Offers<span
                    class="line line--small"><span class="line__first"></span><span
            ...
            <div id="carousel-small" class="owl-carousel enable-owl-carousel" data-auto-play="5000"
                ...
                data-items-desktop="2" data-items-desktop-small="2" data-items-tablet="1"
                            ...
                            <div class="col-xs-6">
                                <div class="offer__img">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/media/270x270/offer1.jpg') }}" alt="bike" />
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="offer__info">
                                    ...
                                    <ul class="list">
                                        ...
                                        <li><span class="list__circle"><span
                                                    class="fa fa-check"></span></span>Placerat Nunc placerat </li>
                                    </ul>
                    ...
                    <div class="offer">
                        <div class="row row--no-padding">
                            <div class="col-xs-6">
                                <div class="offer__img">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/media/270x270/offer2.jpg') }}" alt="bike" />
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="offer__info">
    ...
    <div class="reviews">
        <div class="container">
            <ul class="reviews-slider enable-bx-slider" data-auto="true" data-auto-hover="true"
                data-mode="horizontal" data-pager="false" data-pager-custom="null" data-prev-selector="null"
                data-next-selector="null">
                <li>
        ...
        <div class="container">
            <header class="tab-header clearfix wow slideInLeft" data-wow-delay="0.7s" data-wow-duration="1.5s">
                ...
                <div class="tab-toggles pull-right js-isotope-btns">
                    <a href="#" class="button button--grey button--main btn js-isotope-btn"
                        data-sort-by="name">BY TYPE</a>
            ...
            <div class="row isotope">
                <div class="col-md-3 col-xs-6 isotope-item wow zoomInUp" data-wow-delay="0.7s"
                    data-wow-duration="1.5s">
                    <a href="shop.html"
        ...
        <div class="container-fluid no-padding">
            <div class="row row--no-padding">
                ...
                <div class="col-lg-8 col-xs-12">
                    <div class="row row--no-padding">
                        <div class="col-sm-6 col-xs-12 wow zoomInDown" data-wow-delay="0.7s"
                            data-wow-duration="1.5s">
                        ...
                        <div class="col-sm-6 col-xs-12 wow zoomInRight" data-wow-delay="0.7s"
                            data-wow-duration="1.5s">
                            <a href="article.html" class="blog-anons no-decoration">
                                <div class="blog-anons__img">
                ...
                <div class="col-lg-7 col-md-6 col-xs-12">
                    <form action="https://pro-theme.com/" method="post" class="sign-form">
                        <div class="relative-pos">
                            <div class="input-triangle"></div><input class="sign-input" type="text"
                                name="sign" placeholder="Enter your email address" />
                        </div>
                        <button type="submit"
                    ...
                    <div class="col-xs-7 wow fadeInLeft" data-wow-delay="0.7s" data-wow-duration="1.5s">
                        <div class="map">
                            <script type="text/javascript" charset="utf-8"
                                src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=W-Xpe7AurTrL7tXe8sROgCD2phwBIWEj&amp;width=auto&amp;height=380&amp;lang=en_US&amp;sourceType=constructor">
                            </script>
                        </div>
                    </div>
